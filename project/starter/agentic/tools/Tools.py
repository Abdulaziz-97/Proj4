...
@tool
def search_knowledge_base(query: str, tags: Optional[str] = None) -> List[Dict]:
    """Find relevant KB articles"""
    return knowledge_retrieval_agent.invoke(f"Search the knowledge base for articles related to: {query} with tags: {tags}")  